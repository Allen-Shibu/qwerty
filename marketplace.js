...
if (WishGrid) {
  ...
  if(WishList.length == 0){
    WishGrid.innerHTML = `<p class="flex text-gray-500 items-center justify-center text-2xl ">Your wishlist is empty.....</p>`;
  }
  else {
    WishGrid.forEach((product, index) => {
      const card = document.createElement('div')
      
      card.innerHTML = `<div class="relative overflow-hidden rounded-2xl">
